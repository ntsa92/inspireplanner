...
const columns = [
    ...
    { label: 'Priority', fieldName: 'priority', type: 'text', editable: true, initialWidth: 130 },
...
export default class TaskList extends LightningElement {
    ...
    startEditMode() {
        ...
        const dt = this.template.querySelector('c-custom-data-table');
    ...
    handleChange(e) {
        console.log('Changed: ', e.detail.draftValues);
    ...
    // Supprimer la tâche sélectionné
    deleteTask(){
        const selectedRow = this.template.querySelector('c-custom-data-table').getSelectedRow();
    }
